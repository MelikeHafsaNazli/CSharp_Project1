...
class Project_1
{
    ...
    {
        Kisiler.Add(new TelefonDefteri() { Isim = "Ali Eren", Soyisim = "Sönmez", TelNo = "1111111111" });
        Kisiler.Add(new TelefonDefteri() { Isim = "Metin", Soyisim = "Sönmez", TelNo = "22222222222" });
        Kisiler.Add(new TelefonDefteri() { Isim = "Meltem", Soyisim = "Sönmez", TelNo = "33333333333" });
        Kisiler.Add(new TelefonDefteri() { Isim = "Yaren", Soyisim = "Sönmez", TelNo = "44444444444" });
        Kisiler.Add(new TelefonDefteri() { Isim = "Ahmet", Soyisim = "Yılmaz", TelNo = "555555555555" });
    }
}